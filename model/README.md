...
- [`model.schema.json`](./model.schema.json) defines the shared artifact, requirement, requirement-coverage, trace, topic-view, evidence, retired-ledger, and catalog shapes used by canonical JSON documents and validation tooling.
