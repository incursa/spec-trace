...
- To define or revise derived reporting, coverage dimensions, or attestation semantics, work inside [`specs/requirements/spec-trace/SPEC-RPT.md`](./specs/requirements/spec-trace/SPEC-RPT.md) and use [`skills/spec-trace-change-maintainer/`](./skills/spec-trace-change-maintainer/).
...
- [`artifact-model-explainer.md`](./artifact-model-explainer.md) is the plain-language operational model for artifact families, provenance, direct refs, and downstream trace.
- [`profiles-and-attestation-explainer.md`](./profiles-and-attestation-explainer.md) explains static trace versus dynamic attestation and the local-policy meaning of `implemented`, `verified`, and `release-ready`.
