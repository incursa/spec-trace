...
- `../../spec-template.md`
- the closest example specification under `../../examples/`
...
2. If a new specification is warranted, start from `../../spec-template.md` and place the file under the appropriate domain path.
