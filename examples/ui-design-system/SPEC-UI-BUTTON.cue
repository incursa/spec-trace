...
artifact: model.#Specification & {
    ...
    purpose: "Define the shared contract for button surfaces in the UI design system."
    scope: """
    ...
    requirements: [
        {
            id: "REQ-UI-BUTTON-0001"
            title: "Expose the button block surface"
            statement: """
        ...
        {
            id: "REQ-UI-BUTTON-0002"
            title: "Define the primary button variant"
            statement: """
        ...
        {
            id: "REQ-UI-BUTTON-0003"
            title: "Define the secondary button variant"
            statement: """
        ...
        {
            id: "REQ-UI-BUTTON-0004"
            title: "Define button size modifiers"
            statement: """
        ...
        {
            id: "REQ-UI-BUTTON-0005"
            title: "Define the disabled button state"
            statement: "The `ui-button--disabled` modifier MUST satisfy [`REQ-UI-FOUNDATION-0002`](./SPEC-UI-FOUNDATION.md)."
            trace: {
                related: [
        ...
        {
            id: "REQ-UI-BUTTON-0006"
            title: "Define the focus-visible button state"
            statement: "The `ui-button--focus-visible` modifier MUST satisfy [`REQ-UI-FOUNDATION-0001`](./SPEC-UI-FOUNDATION.md)."
            trace: {
                related: [
